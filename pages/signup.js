                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='m-auto'>
                            <div className='min-w-[364px] max-w-[364px] px-[16px] pb-[32px] flex flex-col'>
                                <h1 className='my-[20px] leading-[36px]  text-[31px] font-bold text-black'>Join Twitter today</h1>
                                ...
                                <div className='bg-black text-white rounded-full text-center cursor-pointer my-[12px]'>
                                    <button onClick={handleLogin} className='py-[12px] font-bold ' type='submit'>Create account</button>
                                </div>
                                <button className='text-[13px] font-normal'>By signing up, you agree to the <span className='text-[#1D9BF0]'>Terms of Service</span> and <span className='text-[#1D9BF0]'>Privacy Policy</span>, including <span className='text-[#1D9BF0]'>Cookie Use.</span></button>
                                <div className='mt-[40px] text-[15px]'>
                                    <span className='text-[#536471]'>Have an account already? </span>
                                    <span className='text-[#1D9BF0]'><Link href={`/login`}>Log in</Link></span>
                                </div>
                            </div>
                        </div>
                    </div>
