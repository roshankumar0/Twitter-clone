      ...
      <div className='w-[350px] fixed   '>
        <div className='flex flex-col'>
          <div className='h-[56px] min-h-[32px] flex fixed  items-center  z-20 bg-white'>
            <div className='flex-1 flex items-center text-[#677682] bg-[#EFF3F4]  rounded-full p-[17px] h-[44px]' style={{ width: '350px' }}>
          ...
          <div className=''>
           <div  className='-z-40 bg-[#F7F9F9] mt-[64px] rounded-2xl'>
